...
MIV_fnc_query_db               = compile preprocessFileLineNumbers "core\scripts\db\query_db.sqf";
MIV_fnc_connect_db             = compile preprocessFileLineNumbers "core\scripts\db\connect_db.sqf";

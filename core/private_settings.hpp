...
TEMPLATE_LAST_UPDATE = "2024-7-19";                 // Escribir la fecha en formato AAAA-M-D sin ceros en el mes o el día.
...
ROLES_NEEDING_PLATOON = ["lider_peloton","lider_escuadra_1","lider_escuadra_2","lider_escuadra_3","lider_fog","sublider_escuadra_1","sublider_escuadra_2","sublider_escuadra_3","sublider_fog"];

...
private _textTwo = getMissionConfigValue ["LeyendaTwo",""];
private _textThree = getMissionConfigValue ["LeyendaThree",""];
...
if ((_hasIntel == "2")) then
{
player createDiaryRecord["Diary", ["Intel", "<br/><p align='center'><font color='#ffffff' size='12'>"+_textTwo+"</font></p><br/><br/><img image= '"+_IntelTwo+"' width='400' height='225'/><br/>"]];
player createDiaryRecord["Diary", ["Intel", "<br/><p align='center'><font color='#ffffff' size='12'>"+_textOne+"</font></p><br/><br/><img image= '"+_IntelOne+"' width='400' height='225'/><br/>"]];
};

if ((_hasIntel == "3")) then
{
player createDiaryRecord["Diary", ["Intel", "<br/><p align='center'><font color='#ffffff' size='12'>"+_textThree+"</font></p><br/><br/><img image= '"+_IntelThree+"' width='400' height='225'/><br/>"]];
player createDiaryRecord["Diary", ["Intel", "<br/><p align='center'><font color='#ffffff' size='12'>"+_textTwo+"</font></p><br/><br/><img image= '"+_IntelTwo+"' width='400' height='225'/><br/>"]];
player createDiaryRecord["Diary", ["Intel", "<br/><p align='center'><font color='#ffffff' size='12'>"+_textOne+"</font></p><br/><br/><img image= '"+_IntelOne+"' width='400' height='225'/><br/>"]];
};
